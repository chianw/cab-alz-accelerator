...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name               = "rgbca-management-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name = "rgbca-hub-$${starter_location_01}"
    dns_resource_group_name                      = "rgbca-hub-dns-$${starter_location_01}"
    ddos_resource_group_name                     = "rgbca-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name               = "rg-asc-export-$${starter_location_01}"

    # Resource names
    log_analytics_workspace_name            = "bcalaw-management-$${starter_location_01}"
    ddos_protection_plan_name               = "ddos-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "bcauami-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "bcadcr-change-tracking"
    dcr_defender_sql_name                   = "bcadcr-defender-sql"
    dcr_vm_insights_name                    = "bcadcr-vm-insights"
